...
app.get('/tweets?start=201810260000', (req, res) => {
...
app.get('/tweets?start=201810250000', (req, res) => {
...
app.get('/tweets?start=201810240000', (req, res) => {
...
app.get('/tweets?start=201810230000', (req, res) => {
...
app.get('/tweets?start=201810220000', (req, res) => {
...
app.get('/tweets?start=201810210000', (req, res) => {
...
app.get('/tweets?start=201810200000', (req, res) => {
