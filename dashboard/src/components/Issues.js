    ...
    return (
      <section className="App" style={sectionStyle}>
        <div>
          ...
          <div style={msgStyle}>
            {Object.keys(this.state.complaints[this.state.value]).sort((a,b)=>{return this.state.complaints[this.state.value][b]-this.state.complaints[this.state.value][a]}).map(complaint=>{return (msgBox(this.state.complaints[this.state.value][complaint]))})}
          </div>
          <div style={msgStyle}>
